...
/** Java MyBatis 课站独立 storage，避免与其他 learning-* 冲突 */
export const CTP_STORAGE_KEY = "java-mybatis-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "java-mybatis-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Green，贴合 Java 技术栈 */
export const DEFAULT_CTP_ACCENT: CtpAccent = "sapphire";
