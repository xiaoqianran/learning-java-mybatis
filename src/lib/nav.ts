...
> = {
  基础: { order: 1, label: "① 基础", blurb: "配置 · 映射 · 注解 CRUD" },
  "Spring 整合": { order: 2, label: "② Spring 整合", blurb: "starter · 分层 · 事务" },
  "动态 SQL": { order: 3, label: "③ 动态 SQL", blurb: "if · where · foreach · set" },
  "关联与分页": { order: 4, label: "④ 关联分页", blurb: "association · collection · LIMIT" },
  工程化: { order: 5, label: "⑤ 工程化", blurb: "缓存 · MP · 规范" },
  面试串讲: { order: 6, label: "⑥ 面试串讲", blurb: "高频题 · 插件 · TypeHandler" },
};
...
export const NAV_PRIMARY: NavItem[] = [
  { to: "/docs", label: "文档", hint: "查 · 官方对照地图", icon: Library },
  { to: "/studio", label: "工坊", hint: "练 · 模拟 REST CRUD", icon: Server },
...
export const NAV_TOOLS: NavItem[] = [
  ...
  { to: "/playground", label: "Mapper 沙箱", hint: "SQL / 动态标签", icon: Code2 },
